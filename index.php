  ...
  ?>
	...
	<div class="slider_area">
	            <div class="single_slider d-flex align-items-center slider_bg_1">
                                    <div class="container">
                                    <h3 class="text-light animated bounceInRight">Welcome To Real Estate Property Management System.</h3>

                                     <p class="text-light">This Portal is designed to provide the facility using which customer can buy or sale their properties such as land, shop and house.
                                     Just you have to register yourself on the web portal. Once you register yourself,
                                     you can upload information of the properties you want to sale and you can also search properties to buy. </p>
                                   </div>
	                                </div>
