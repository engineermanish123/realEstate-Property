...
?>
	<div class="container col-lg-4">
		...
		<div id="sprytextfield1" class="form-group">
			<input type="text" class="form-control" name="txtNewsId" id="txtNewsId" value="<?php echo $Id;?>" />
		</div>

		<div id="sprytextfield2" class="form-group">
			<input type="text" class="form-control" name="txtNews" id="txtNews" value="<?php echo $News;?>" required="required"/>
		</div>

		<div id="sprytextfield3" class="form-group">
			<input type="text" class="form-control" onclick="ds_sh(this);"  name="txtDate" id="txtDate" value="<?php echo $NewsDate;?>" required="required" />
		</div>
